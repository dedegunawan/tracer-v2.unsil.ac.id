...
function check_kontak($email, $no_hp) {
	...
	if (!$emailV) {
		return "Email tidak valid, <span style='color:red;'>'{$email}'</span>";
	}
	if (!$no_hpV) {
...
class CleaningPengguna extends CI_Controller {
	use TraitTemplate;
	use LoginTrait;
	...
	public function index()
	{
		...
		*/
		...
		echo $this->template->render('content/cleaningpengguna/index');
	}
