...
class SaranAlumni extends CI_Controller {
	use TraitTemplate;
	use LoginTrait;
	...
	public function index()
	{
		...
		echo $this->template->render('content/saranalumni/index');
	}
	...
	function lihat($id) {
		...
		echo $this->template->render('content/saranalumni/lihat');
	}
	...
	function do_xls_download() {
		...
		echo $this->template->render('content/saranalumni/xlsDownload');
	}
	function do_pdf_cetak() {
		...
		echo $this->template->render('content/saranalumni/pdfDownload');
	}
	public function tambah()
	{
		...
		if($this->form_validation->run() == false) {
			...
			echo $this->template->render('content/saranalumni/tambah');
		} else {
